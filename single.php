...
<section id="content">
                        ...
                        <div class="col-md-7 product-single">
                            ...
                            <div class="product-meta">
                                <span>Categories: 
                                    ...
                                    ?>
                                    <a href="index.php?id=<?php echo $prodr['catid']; ?>"><?php echo $prodcatr['name']; ?></a></span><br>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <ul class="comment-list">
                                        ...
                                        while ($selrevr = mysqli_fetch_assoc($selrevres)) {
                                            ?>
                                            <li>
                                                <a class="pull-left" href="#"><img class="comment-avatar" src="admin/images/avatar.png" alt="" height="50" width="50"></a>
                                    ...
                                    <?php
                                    if (isset($uid)) {
                                        $chkrevsql = "SELECT count(*) reviewcount FROM reviews r WHERE r.uid=$uid AND pid=$id";
    ...
    <?php echo $relr['price']; ?><span>Eu</span></div>
                                        </div>
                                    </div>
<?php } ?>
                            </div>
