...
if (isset($_POST) & !empty($_POST)) {
    ...
    if (isset($_POST['agree'])) {
        ...
        if ($count == 1) {
            ...
            $sql = "UPDATE usersmeta SET country='$country', firstname='$fname', lastname='$lname', address1='$address1', address2='$address2', city='$city', state='$state',  zip='$zip', company='$company', phone='$phone' WHERE uid='$uid'";
            $res = mysqli_query($connection, $sql) or die(mysqli_error($connection));
        } else {
            //insert data in usersmeta table
            $sql = "INSERT INTO usersmeta (country, firstname, lastname, address1, address2, city, state, zip, company, phone, uid) VALUES ('$country', '$fname', '$lname', '$address1', '$address2', '$city', '$state', '$zip', '$company', '$phone', '$uid')";
            $res = mysqli_query($connection, $sql) or die(mysqli_error($connection));
        }
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="billing-details">
                            ...
                            <div class="clearfix space20"></div>
                            <label>Phone </label>
                            <input name="phone" class="form-control" placeholder="" value="<?php
                            if (!empty($r['phone'])) {
                                echo $r['phone'];
                            } elseif (isset($phone)) {
                                echo $phone;
                ...
                <table class="table table-bordered extra-padding">
                    <tbody>
                        <tr>
                            <th>Cart Subtotal</th>
                            <td><span class="amount"><?php echo $total; ?> Eu</span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th>Order Total</th>
                            <td><strong><span class="amount"><?php echo $total; ?> Eu</span></strong> </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="payment-method">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <input name="payment" id="radio1" class="css-checkbox" type="radio" value="cod" checked><span>Cash On Delivery</span>
                    ...
                    <input name="agree" id="checkbox1" class="css-checkbox" type="checkbox" value="false"><span>I've read and accept the <a href="#">terms &amp; conditions</a></span>
