...
if (isset($_POST) & !empty($_POST)) {
    ...
    $usql = "UPDATE usersmeta SET country='$country', firstname='$fname', lastname='$lname', address1='$address1', address2='$address2', city='$city', state='$state',  zip='$zip', company='$company', phone='$phone' WHERE uid=$uid";
    $ures = mysqli_query($connection, $usql) or die(mysqli_error($connection));
    if ($ures) {
        $smsg = "Detail Submitted Successfully";
    } else {
        $fmsg = "Failed to Submit Detail";
    }
}
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="billing-details">
                            ...
                            <div class="clearfix space20"></div>
                            <label>Phone </label>
                            <input name="phone" class="form-control" id="billing_phone" placeholder="Phone" 
                                   value="<?php
                                   if (!empty($r['phone'])) {
                                       echo $r['phone'];
                                   } elseif (isset($phone)) {
